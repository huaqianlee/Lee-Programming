...
void solve(double meal_cost, int tip_percent, int tax_percent) {
	// Review questions carefully, I do the wrong codes because of misunderstanding the questions first time.
	//meal_cost += meal_cost * (double)tip_percent/100;
	//meal_cost += meal_cost * (double)tax_percent/100;
	meal_cost += meal_cost * (double)(tip_percent + tax_percent)/100;
